  ...
  describe "#create_user" do
    ...
    context "an error happened" do
      it "should raise an error" do
        ...
        expect {
          subject
        }.to raise_error(RocketChatInterface::UserCreationError).with_message("some error for user #{user.id}")
      end
    end
  end
  ...
  describe "#get_user" do
    ...
    context "an error happened" do
      it "should raise an error" do
        ...
        expect {
          subject
        }.to raise_error(RocketChatInterface::UserInfoError).with_message("some error for user 1")
      end
    end
  end
  ...
  describe "#list_groups" do
    ...
    context "an error happened" do
      it "should raise an error" do
        ...
        expect {
          subject
        }.to raise_error(RocketChatInterface::RocketChatError).with_message("some error when listing private rooms")
      end
    end
  end
  ...
  describe "#get_group" do
    ...
    context "an error happened" do
      it "should raise an error" do
        ...
        expect {
          subject
        }.to raise_error(RocketChatInterface::RocketChatError).with_message("some error when listing group 1")
      end
    end
  end
  ...
  describe "#create_group" do
    ...
    context "an error happened" do
      it "should raise an error" do
        ...
        expect {
          subject
        }.to raise_error(RocketChatInterface::RocketChatError).with_message("some error when creating group <group_name>")
      end
    end
  end
  ...
  describe "#delete_group" do
    ...
    context "an error happened" do
      it "should raise an error" do
        ...
        expect {
          subject
        }.to raise_error(RocketChatInterface::RocketChatError).with_message("some error when deleting group 1")
      end
    end
  end
  ...
  describe "#add_owner_to_group" do
    ...
    context "an error happened" do
      it "should raise an error" do
        ...
        expect {
          subject
        }.to raise_error(RocketChatInterface::RocketChatError).with_message("some error when adding owner 2 to group 1")
      end
    end
  end
  ...
  describe "#add_moderator_to_group" do
    ...
    context "an error happened" do
      it "should raise an error" do
        ...
        expect {
          subject
        }.to raise_error(RocketChatInterface::RocketChatError).with_message("some error when adding moderator 2 to group 1")
      end
    end
  end
  ...
  describe "#generate_auth_token_for_user" do
    ...
    context "an error happened" do
      it "should raise an error" do
        ...
        expect {
          subject
        }.to raise_error(RocketChatInterface::RocketChatError).with_message("some error when generating token for user 1")
      end
    end
  end
end
